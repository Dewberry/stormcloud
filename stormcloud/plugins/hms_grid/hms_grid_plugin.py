...
PLUGIN_PARAMS = {"required": ["metadata_s3_uris", "watershed", "output_zip_s3_uri"], "optional": []}
...
def main(params: dict) -> dict:
    ...
    with TemporaryDirectory() as tmp_dir:
        full_directory_path = os.path.join(tmp_dir, params["watershed"])
        ...
        output_zip = make_archive(zip_path, "zip", tmp_dir, params["watershed"])
        logging.info(f"uploading zip output to {output_zip}")
